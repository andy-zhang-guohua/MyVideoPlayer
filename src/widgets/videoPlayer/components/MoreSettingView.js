            ...
            <Text style={styles.optionText}>多倍速播放</Text>
            {
              playRateItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <Text style={[styles.optionText, isSelected ? styles.optionTextActive : null]}>{item}X</Text>
                  </TouchableOpacity>
                )
              })
            }
            ...
            <Text style={styles.optionText}>定时关闭</Text>
            {
              endTimeItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <Text style={[styles.optionText, isSelected ? styles.optionTextActive: null]}>{item}</Text>
                  </TouchableOpacity>
                )
              })
            }
